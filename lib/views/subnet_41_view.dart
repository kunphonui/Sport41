...
import 'package:sportapp/bloc/sport_bloc.dart';
import 'package:sportapp/bloc/sport_event.dart';
import 'package:sportapp/bloc/sport_state.dart';
import 'package:sportapp/repositories/sport_repository.dart';
import 'package:sportapp/views/update_match_view.dart';

class Subnet41View extends StatefulWidget {
  const Subnet41View({super.key});

  @override
  State createState() => _MyAppState();
}

class _MyAppState extends State<Subnet41View> {
  DateTime? dateTime;
        ...
        listener: (context, state) {
          if (state is ShowDatePickerState) {
            ...
            ScaffoldMessenger.of(context).showSnackBar(
              const SnackBar(content: Text('All matches updated successfully')),
            );
